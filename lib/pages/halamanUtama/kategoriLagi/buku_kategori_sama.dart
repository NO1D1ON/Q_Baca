...
import 'package:q_baca/pages/halamanUtama/home_controller.dart'; // Import untuk HomeController
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      ...
      child: Scaffold(
        ...
        // App bar dengan design yang lebih modern
        appBar: AppBar(
          title: Text(
            category.name,
        ...
        body: Consumer<CategoryBooksController>(
          builder: (context, controller, child) {
            ...
            // Tampilkan grid view dengan buku-buku dalam kategori
            return _buildBooksGrid(context, controller.books);
          },
        ),
      ),
    );
