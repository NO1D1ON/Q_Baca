...
import 'package:q_baca/pages/halamanUtama/beranda/home_controller.dart'; // <-- Gunakan HomeController
import 'package:q_baca/pages/halamanUtama/profil/account_page.dart'; // <-- Import halaman baru
